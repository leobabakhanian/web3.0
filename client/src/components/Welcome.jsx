...
const Input = ({placeholder, name, type, value, handleChange}) => (
    ...
    onChange={(e) => handleChange(e, name)} className="my-2 w-full rounded-sm p-2 outline-none
        bg-transparent text-white border-none text-sm white-glass" />
)
            ...
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
                        Send Ethereum<br /> across the web
                    </h1>
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                        Explore the world of crypto and NFTs by sending and receiving Ethereum
                    </p>
                    {!currentAccount && (
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glass">
                        ...
                        <Input placeholder="GIF Keyword" name="gif" type="text" handleChange={handleChange} />
                        ...
                        {isLoading ? (
                            ...
                            <button type="button" onClick={handleSubmit} className="text-white w-full mt-2 border-[1px]
